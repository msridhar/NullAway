  ...
  public void generatedAsUnannotatedPlusRestrictive() {
    ...
    makeTestHelperWithArgs(
        ...
        .addSourceLines(
            ...
            "class Test {",
            "  void foo() {",
            "    (new Generated()).retNull().toString();",
            "  }",
            "}")
        .doTest();
  }
  ...
  public void overridingRestrictivelyAnnotatedMethod() {
    makeTestHelperWithArgs(
        ...
        .addSourceLines(
            ...
            "",
            "  @Override",
            "  public void acceptsNonNull(@Nullable Object o) {}",
            "",
            "  @Override",
            "  public void acceptsNonNull2(Object o) {}",
            "",
            "  @Override",
        ...
        .addSourceLines(
            ...
            "  public @Nullable Object returnsNonNull2() {",
            "    return new Object();",
            "  }",
            "}")
        .doTest();
  ...
  public void annotatedVsUnannotatedMethodRefOverrideChecks() {
    makeTestHelperWithArgs(
        ...
        .addSourceLines(
            ...
            "    return Maps.toMap(",
            "        keys, /* is Function<String, String!> */ AnnotatedStringIDFunctions::idRetNonNull);",
            "  }",
            "",
            ...
            "    return Maps.toMap(",
            "        keys, /* is Function<String, String!> */ UnannotatedStringIDFunctions::idRetNonNull);",
            "  }",
            "",
            ...
            "    return Maps.toMap(",
            "        keys, /* is Function<String, String?> */ UnannotatedStringIDFunctions::idRetNullable);",
            "  }",
            "}")
        .doTest();
  }
