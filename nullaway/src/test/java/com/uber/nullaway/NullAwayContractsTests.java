  ...
  public void basicContractAnnotation() {
    makeTestHelperWithArgs(
        ...
        .addSourceLines(
            ...
            "  static boolean isNull(boolean flag, @Nullable Object o) {",
            "    return o == null;",
            "  }",
            "",
            "  @Contract(\"null -> false\")",
  ...
  public void impliesNonNullContractAnnotation() {
    makeTestHelperWithArgs(
        ...
        .addSourceLines(
            ...
            "public class NullnessChecker {",
            "  @Contract(\"!null -> !null\")",
            "  static @Nullable Object noOp(@Nullable Object o) {",
            "    return o;",
            "  }",
            "}")
        .addSourceLines(
  ...
  public void malformedContractAnnotations() {
    makeTestHelperWithArgs(
        ...
        .addSourceLines(
            ...
            "class Test {",
            "  @Contract(\"!null -> -> !null\")",
            "  static @Nullable Object foo(@Nullable Object o) {",
            "    return o;",
            "  }",
            "",
            "  @Contract(\"!null -> !null\")",
            "  static @Nullable Object bar(@Nullable Object o, String s) {",
            "    return o;",
            "  }",
            "",
            "  @Contract(\"jabberwocky -> !null\")",
            "  static @Nullable Object baz(@Nullable Object o) {",
            "    return o;",
            "  }",
            "",
            "  @Contract(\"!null -> -> !null\")",
            "  static @Nullable Object dontcare(@Nullable Object o) {",
            "    return o;",
            "  }",
            "",
            "  static Object test1() {",
  ...
  public void contractUnreachablePath() {
    makeTestHelperWithArgs(
        ...
        .addSourceLines(
            ...
            "    return NullnessChecker.isNull(required) ? required.toString() : required.toString();",
            "  }",
            "}")
        .doTest();
  }
