  ...
  public void contractUnreachablePath() {
    helper()
        .addSourceLines(
            ...
            "    return Validation.identity(required == null) ? required.toString() : required.toString();",
            "  }",
            "}")
        .doTest();
  }
  ...
  public void complexContractUnreachablePath() {
    helper()
        .addSourceLines(
            ...
            "    return Validation.identity(required == null, other) ? required.toString() : required.toString();",
            "  }",
            "}")
        .doTest();
  }
  ...
  public void contractNestedBooleanNullness() {
    helper()
        .addSourceLines(
            ...
            "            // BUG: Diagnostic contains: dereferenced expression",
            "            : o.toString())",
            "        : (Validation.identity(o != null) ? o.toString() : o.toString());",
            "  }",
            "}")
        .doTest();
  }
  ...
  public void complexContractNestedBooleanNullness() {
    helper()
        .addSourceLines(
            ...
            "            // BUG: Diagnostic contains: dereferenced expression",
            "            : o.toString())",
            "        : (Validation.identity(o != null, other) ? o.toString() : o.toString());",
            "  }",
            "}")
        .doTest();
  }
