  ...
  public void supportRequiresNonNullOverridingTest() {
    defaultCompilationHelper
        ...
        .addSourceLines(
            ...
            "",
            "  @RequiresNonNull(\"b\")",
            "  // BUG: Diagnostic contains: precondition inheritance is violated, method in child class cannot",
            "  // have a stricter precondition than its closest overridden method, adding @requiresNonNull for",
            "  // fields [a] makes this method precondition stricter",
            "  public void test4() {",
            "    // BUG: Diagnostic contains: dereferenced expression a is @Nullable",
            "    a.call();",
            "    b.call();",
  ...
  public void ensuresNonNullInterpretation() {
    defaultCompilationHelper
        .addSourceLines(
            ...
            "",
            "  @EnsuresNonNull(\"nullItem\")",
            "  // BUG: Diagnostic contains: test2() is annotated with @EnsuresNonNull annotation, it indicates",
            "  // that all fields in the annotation parameter must be guaranteed to be nonnull at exit point.",
            "  // However, the method's body fails to ensure this for the following fields: [nullItem]",
            "  public void test2() {}",
            "",
            ...
            "  // BUG: Diagnostic contains: currently @EnsuresNonNull supports only class fields of the method",
            "  // receiver: other.nullItem is not supported",
            "  public void test4() {",
            "    nullItem = new Item();",
            "  }",
            "",
            "  @EnsuresNonNull(\"nullItem\")",
            "  // BUG: Diagnostic contains: method: test5() is annotated with @EnsuresNonNull annotation, it",
            "  // indicates that all fields in the annotation parameter must be guaranteed to be nonnull at exit",
            "  // point. However, the method's body fails to ensure this for the following fields: [nullItem]",
            "  public void test5() {",
            "    this.foo.test1();",
            "  }",
            "",
  ...
  public void supportEnsuresNonNullOverridingTest() {
    defaultCompilationHelper
        ...
        .addSourceLines(
            ...
            "",
            "  @EnsuresNonNull(\"b\")",
            "  // BUG: Diagnostic contains: postcondition inheritance is violated, this method must guarantee",
            "  // that all fields written in the @EnsuresNonNull annotation of overridden method SuperClass.test1",
            "  // are @NonNull at exit point as well. Fields [a] must explicitly appear as parameters at this",
            "  // method @EnsuresNonNull annotation",
            "  public void test1() {",
            "    b = new Item();",
            "  }",
            "",
            ...
            "  }",
            "  // BUG: Diagnostic contains: postcondition inheritance is violated, this method must guarantee",
            "  // that all fields written in the @EnsuresNonNull annotation of overridden method",
            "  // SuperClass.noAnnotation are @NonNull at exit point as well. Fields [a] must explicitly appear",
            "  // as parameters at this method @EnsuresNonNull annotation",
            "  public void noAnnotation() {}",
            "}")
        .addSourceLines(
            "Item.java", "package com.uber;", "", "class Item {", "  public void call() {}", "}")
